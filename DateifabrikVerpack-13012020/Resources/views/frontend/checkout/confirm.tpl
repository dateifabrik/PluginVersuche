{* Hier könn(t)en die Original-Blöcke überschrieben werden *}
                    ...
                    <span class="block">
                        ...
                        <div class="panel--body">
                            ...
                            <span class="block column--label">
                                ...
                                <ul id="myoutput" class="listing--container" style="display: none;">
                                    {$dbank|print_r}
                                {foreach $dbank as $dbdata_key => $dbdata_value}
                                    <li>{$dbdata_key} => {$dbdata_value}</li>
                                {/foreach}
                                </ul>
                                <p></p>
                                <ul class="listing--container">
                                {foreach $arr_gewicht as $gewicht_value}
                                    <li>{$gewicht_value}</li>
                                {/foreach}
                                </ul>
                            </span>
